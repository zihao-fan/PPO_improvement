...
class LnLstmPolicy(object):
    def __init__(self, sess, ob_space, ac_space, nbatch, nsteps, nlstm=256, reuse=False, scope_name="model"):
        nenv = nbatch // nsteps
...
class CnnPolicy(object):
    ...
    def __init__(self, sess, ob_space, ac_space, nbatch, nsteps, reuse=False, scope_name="model"): #pylint: disable=W0613
        nh, nw, nc = ob_space.shape
        ob_shape = (nbatch, nh, nw, nc)
        nact = ac_space.n
        X = tf.placeholder(tf.uint8, ob_shape) #obs
